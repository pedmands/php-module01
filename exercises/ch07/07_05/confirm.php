...
<head>
<meta charset="utf-8">
<title>Order Confirmation - Hansel and Petal</title>
    ...
    <div id="content">
        <div id="breadcrumbs" class="reset menu">
            <ul>
                ...
                <li><a href="order.php">Basket</a></li>
                <li>Order confirmation</li>
            </ul>
        </div>
        <div id="col_1" role="main">
            <h1 class="inline_block">Confirming Your Order</h1>          
            <p>This page doesn't actually do anything. It's simply to show how redirection works.</p>
        </div>
        <div id="col_2">
        <h3>How to Order</h3>
